Shader "IndirectRendering/URP/IndirectSimpleLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            RWStructuredBuffer<Matrix2x2> _MatrixRows01;
            RWStructuredBuffer<Matrix2x2> _MatrixRows23;
            RWStructuredBuffer<Matrix2x2> _MatrixRows45;
            #endif
            ...
            void setup()
            {
                ...
                Matrix2x2 rows01 = _MatrixRows01[index];
                Matrix2x2 rows23 = _MatrixRows23[index];
                Matrix2x2 rows45 = _MatrixRows45[index];
            ...
            void InitializeInputData(Varyings input, half3 normalTS, out InputData inputData)
            {
                ...
                inputData.normalWS = TransformTangentToWorld(
                    normalTS, half3x3(input.tangentWS.xyz, input.bitangentWS.xyz, input.normalWS.xyz));
                #else
            ...
            // RWStructuredBuffer<float4x4> _Debug;

            // Vertex Shader
            Varyings LitPassVertex(Attributes IN, uint instanceID: SV_InstanceID)
            {
                Varyings OUT;
