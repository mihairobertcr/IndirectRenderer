    ...
    public class LodsSortingDispatcher : ComputeShaderDispatcher
    {
        ...
        private void SetSortingData()
        {
            ...
            for (var i = 0; i < meshes.Count; i++)
            {
                ...
                {
                    var drawCallIndex = (((uint)i * (uint)Context.Arguments.MeshArgumentsCount) << 16) +
                                        instancesCount;
        ...
        public void SetupSortingCommand()
        {
            ...
            for (uint l = (BITONIC_BLOCK_SIZE << 1); l <= elements; l <<= 1)
            {
                ...
                _command.DispatchCompute(ComputeShader, _transposedSortKernel, (int)(width / TRANSPOSE_BLOCK_SIZE),
                    (int)(height / TRANSPOSE_BLOCK_SIZE), 1);
                ...
                _command.DispatchCompute(ComputeShader, _transposedSortKernel, (int)(height / TRANSPOSE_BLOCK_SIZE),
                    (int)(width / TRANSPOSE_BLOCK_SIZE), 1);
