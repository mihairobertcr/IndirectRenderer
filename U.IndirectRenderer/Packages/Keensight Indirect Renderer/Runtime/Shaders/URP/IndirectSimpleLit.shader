Shader "IndirectRendering/URP/IndirectSimpleLit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform uint _ArgumentsOffset;
            StructuredBuffer<uint> _Arguments;
            ...
            void setup()
            {
                ...
                // #else
                uint index = unity_InstanceID + _Arguments[_ArgumentsOffset];
                // #endif
                
                Matrix2x2 rows01 = _MatrixRows01s[index];
                Matrix2x2 rows23 = _MatrixRows23s[index];
                Matrix2x2 rows45 = _MatrixRows45s[index];
